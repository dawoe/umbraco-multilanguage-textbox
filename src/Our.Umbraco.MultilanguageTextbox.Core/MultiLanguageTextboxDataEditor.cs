...
namespace Our.Umbraco.MultilanguageTextbox.Core
{
    ...
    /// </summary>
    [DataEditor(Constants.PropertyEditorAlias, "Multi language text box", "~/App_Plugins/MultiLanguageTextbox/editor.html", ValueType = "JSON", Group = "common", Icon = "icon-indent")]

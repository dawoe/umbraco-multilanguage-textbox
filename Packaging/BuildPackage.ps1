...
$SrcDir = "$RootDir\src"
$SolutionFile = "$SrcDir\Our.Umbraco.MultilanguageTextbox.sln"
...
Compress-Archive -Path "${umbFolder}\*" -DestinationPath "${DistDir}\Our.Umbraco.MultilanguageTextbox_$version.zip" -Force;
